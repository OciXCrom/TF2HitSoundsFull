...
#define PLUGIN_VERSION "1.0 [Full]"
#define XO_PLAYER 5
#define MAX_STREAK 5
...
new const g_szHitSounds[][] = {
	...
	"tf2/hitsound_electro2.wav",
	"tf2/hitsound_electro3.wav",
	"tf2/hitsound_note1.wav",
	"tf2/hitsound_note2.wav",
	"tf2/hitsound_note3.wav",
	"tf2/hitsound_note4.wav",
	"tf2/hitsound_note5.wav",
	"tf2/hitsound_note6.wav",
	"tf2/hitsound_note7.wav",
	"tf2/hitsound_note7b.wav",
	"tf2/hitsound_note8.wav",
	"tf2/hitsound_note9.wav",
	"tf2/hitsound_percussion1.wav",
	"tf2/hitsound_percussion2.wav",
	"tf2/hitsound_percussion3.wav",
	"tf2/hitsound_percussion4.wav",
	"tf2/hitsound_percussion5.wav",
	"tf2/hitsound_retro1.wav",
	"tf2/hitsound_retro2.wav",
	"tf2/hitsound_retro3.wav",
	"tf2/hitsound_retro4.wav",
	"tf2/hitsound_retro5.wav",
	"tf2/hitsound_space.wav",
	"tf2/hitsound_squasher.wav",
	"tf2/hitsound_vortex1.wav",
	"tf2/hitsound_vortex2.wav",
	"tf2/hitsound_vortex3.wav",
	"tf2/hitsound_vortex4.wav",
	"tf2/hitsound_vortex5.wav"
}
...
public player_hitsound(id)
{
	...
	{
		case 1: iSound = 1
		case 2: iSound = random_num(2, 4)
		case 3: iSound = random_num(5, 14)
		case 4: iSound = random_num(15, 19)
		case 5: iSound = random_num(20, 24)
		case 6: iSound = 25
		case 7: iSound = 26
		case 8: iSound = random_num(27, 31)
		case 9: return
	}
